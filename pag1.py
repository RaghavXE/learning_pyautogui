...
p.moveTo(500, 500, duration=4)  # move mouse to XY coordinates over num_second seconds


p.moveRel(200, 200, duration=2) # move mouse relative to its current position
